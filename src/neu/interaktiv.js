...
export const INTERAKTIV = {
  ...
  e2: {
    ...
    daten: {
      ...
      karten: [
        { vorne: "neighbour", hinten: "der Nachbar / die Nachbarin" },
        { vorne: "to borrow", hinten: "(sich) ausleihen" },
        { vorne: "to lend", hinten: "(ver)leihen" },
        { vorne: "crowded", hinten: "überfüllt, voll" },
        { vorne: "on purpose", hinten: "absichtlich" },
        { vorne: "to whisper", hinten: "flüstern" },
        { vorne: "trust", hinten: "das Vertrauen / vertrauen" },
      ],
    },
  },
  e5: {
    ...
    daten: {
      ...
      karten: [
        { vorne: "information centre", hinten: "die Touristen-Information" },
        { vorne: "to recommend", hinten: "empfehlen" },
        { vorne: "entrance fee", hinten: "der Eintrittspreis" },
        { vorne: "guided tour", hinten: "die Führung" },
        { vorne: "nearby", hinten: "in der Nähe" },
        { vorne: "straight ahead", hinten: "geradeaus" },
      ],
    },
  },
  ...
  m2: {
    ...
    daten: {
      ...
      aufgaben: [
        ...
        { frage: "Klicke auf die Gegenzahl von −6.", ziel: 6 },
      ],
    },
  },
};
